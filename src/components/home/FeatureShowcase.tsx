      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
        <ScrollReveal animation="fadeUp" className="mb-16 md:mb-20 mx-auto text-center">
          <div className="flex flex-col items-center justify-center gap-2 mb-4">
            ...
            <h2 className="text-5xl md:text-6xl font-light text-white tracking-tight uppercase reveal-title text-center">
              The Mercedes-Benz Experience
            </h2>
          </div>
          <p className="text-gray-400 text-base font-light leading-relaxed reveal-text max-w-3xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-12 gap-y-16">
          {features.map((feature, index) => (
            <div
              key={index}
              className="feature-card group border border-gray-800 hover:border-gray-600 transition-all duration-300 p-8 hover:translate-y-[-8px]"
            >
              <div className="mb-6 w-16 h-16 border border-gray-700 flex items-center justify-center group-hover:border-white/50 transition-colors">
                {feature.icon}
              </div>
              
              <h3 className="text-xl font-light text-white mb-4 uppercase tracking-wide">{feature.title}</h3>
